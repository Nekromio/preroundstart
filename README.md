Отлично, понял. Тогда скорректируем описание: твой плагин создаёт **эмуляцию события "Pre Round Start"**, которое отсутствует в CS\:S, но есть в CS\:GO. Вот обновлённая документация:
